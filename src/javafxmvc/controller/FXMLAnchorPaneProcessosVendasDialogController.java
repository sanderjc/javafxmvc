...
public class FXMLAnchorPaneProcessosVendasDialogController implements Initializable {
    ...
    private boolean ButtonCofirmarClicked = false;
    private Venda venda;
    ...
    public boolean isButtonCofirmarClicked() {
        return ButtonCofirmarClicked;
    }

    public void setButtonCofirmarClicked(boolean ButtonCofirmarClicked) {
        this.ButtonCofirmarClicked = ButtonCofirmarClicked;
    }
    ...
    private void handleButtonAdicionar(ActionEvent event) {
        ...
        if (comboBoxVendaProduto.getSelectionModel().getSelectedItem() != null) {
            ...
            if (produto.getQuantidade() >= Integer.parseInt(textFieldVendaItemDeVendaQuantidade.getText())) {
                ...
                tableViewItensDeVenda.setItems(observableListProdutos); 
